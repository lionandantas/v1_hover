...
//        if (isEnabledDebugging) Log.v("CircularImageView", "Time taken to draw: " + (System.currentTimeMillis() - currentTime) + "ms");
    ...
    public Matrix getLocalMatrix(ImageView.ScaleType scaleType, RectF rectF, float borderWidth, Bitmap bitmap, DrawerHelper.DrawingType drawingType) {
